const CONFIG={spreadsheetId:'__SFANDOM_MESSAGE_SPREADSHEET_ID__',sheetName:'메시지함',minLength:10,maxLength:1500,cooldownSeconds:60};
...
function doPost(e){
  ...
  try{
    ...
    sheet.appendRow([new Date(),'신규',category,nickname,replyEmail,message,source,'']);
